...
if __name__ == '__main__':
    ...
    basic_stimulus('./data/basic/peak.sti', 'result/fig3_1/peak_contra10_0410.png')
    # basic_stimulus_null('./data/basic/peak_minus.sti', 'result/rh_sti/peak_minus_null00.png')b