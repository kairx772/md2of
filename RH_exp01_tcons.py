...
def basic_stimulus(inputfilen, writefile, tcons):
...
if __name__ == '__main__':
    ...
    velo = float(sys.argv[1])
    tcons = float(sys.argv[2])
    filename = sys.argv[3]
    ...
    if (1):
        ...
        basic_stimulus('./data/05pad/<wx>{}<v>{}.sti'.format(wx, velo), filename, tcons)
